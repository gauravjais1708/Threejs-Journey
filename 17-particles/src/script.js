...
//colors adding to stars 
particlesGeometry.setAttribute('color',new THREE.BufferAttribute(colors,3))

const particlesMaterial=new THREE.PointsMaterial({color:'white',transparent:true,opacity:0.5,blending:THREE.AdditiveBlending,depthWrite:false})
