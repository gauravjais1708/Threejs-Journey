...
import {
  mergeVertices
} from "./chunk-GL6BFKUH.js";
import {
  suspend,
  useFrame,
  useThree
} from "./chunk-WB3HMP63.js";
import {
  BufferAttribute,
  BufferGeometry,
  DynamicDrawUsage,
...
import "./chunk-MRIVXQXR.js";
import {
  require_react
} from "./chunk-EJF42V7Q.js";
import {
  __toESM
...
var useFilterContactPair = (callback) => {
  const {
...
var useFilterIntersectionPair = (callback) => {
  const {
...
var importRapier = async () => {
  let r = await import("./rapier-ETKAZIK4.js");
  await r.init();
  return r;
};
var Physics = (props) => {
  ...
  const filterContactPairHooks = useConst(() => /* @__PURE__ */ new Set());
  const filterIntersectionPairHooks = useConst(() => /* @__PURE__ */ new Set());
  ...
  const step = (0, import_react.useCallback)((dt) => {
    ...
    const stepWorld = (delta) => {
      ...
      world.step(eventQueue, hasHooks ? hooks : void 0);
