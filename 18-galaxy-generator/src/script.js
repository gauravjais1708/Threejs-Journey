...
parameters.spinRandomness = 1
parameters.randomness= 1
parameters.randomnessPower = 3
parameters.sizeRandomness = 0.2 
...
gui.add(parameters,'spinRandomness').min(0).max(2).step(0.01).onFinishChange(generateGalaxy)
gui.add(parameters,'randomness').min(0).max(2).step(0.01).onFinishChange(generateGalaxy)
gui.add(parameters,'sizeRandomness').min(0).max(2).step(0.01).onFinishChange(generateGalaxy)
