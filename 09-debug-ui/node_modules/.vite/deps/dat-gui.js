...
var require_dat_gui = __commonJS({
  "node_modules/dat-gui/vendor/dat.gui.js"(exports, module) {
    ...
    dat.dom = dat.dom || {};
    dat.color = dat.color || {};
    dat.utils.css = /* @__PURE__ */ (function() {
      return {
    ...
    dat.dom.dom = (function(common) {
      ...
      var dom = {
         ...
         * @param params
         */
        fakeEvent: function(elem, eventType, params2, aux) {
          params2 = params2 || {};
          ...
          switch (className) {
            case "MouseEvents":
              ...
              evt.initMouseEvent(
                eventType,
                params2.bubbles || false,
                params2.cancelable || true,
                window,
                params2.clickCount || 1,
                0,
                //screen X
                0,
                //screen Y
    ...
    dat.controllers.NumberController = (function(Controller, common) {
      var NumberController = function(object, property, params2) {
        NumberController.superclass.call(this, object, property);
        params2 = params2 || {};
        this.__min = params2.min;
        this.__max = params2.max;
        this.__step = params2.step;
      ...
      common.extend(
        ...
        {
          setValue: function(v) {
            if (this.__min !== void 0 && v < this.__min) {
              v = this.__min;
            } else if (this.__max !== void 0 && v > this.__max) {
              v = this.__max;
            }
            if (this.__step !== void 0 && v % this.__step != 0) {
    ...
    dat.controllers.NumberControllerBox = (function(NumberController, dom, common) {
      var NumberControllerBox = function(object, property, params2) {
        this.__truncationSuspended = false;
        NumberControllerBox.superclass.call(this, object, property, params2);
        var _this = this;
        var prev_y;
    ...
    dat.controllers.FunctionController = (function(Controller, dom, common) {
      var FunctionController = function(object, property, text) {
        ...
        this.__button.innerHTML = text === void 0 ? "Fire" : text;
    ...
    dat.color.toString = /* @__PURE__ */ (function(common) {
            ...
            THREE_CHAR_HEX: {
              read: function(original) {
                ...
                return {
                  space: "HEX",
                  hex: parseInt(
                    "0x" + test[1].toString() + test[1].toString() + test[2].toString() + test[2].toString() + test[3].toString() + test[3].toString()
                  )
                };
              },
              write: toString
    ...
    dat.GUI = dat.gui.GUI = (function(css, saveDialogueContents, styleSheet, controllerFactory, Controller, BooleanController, FunctionController, NumberControllerBox, NumberControllerSlider, OptionController, ColorController, requestAnimationFrame, CenteredDiv, dom, common) {
      ...
      var GUI = function(params2) {
        ...
        if (!common.isUndefined(params2.load)) {
          if (params2.preset) params2.load.preset = params2.preset;
        } else {
          ...
          /** @lends dat.gui.GUI.prototype */
          {
            ...
            name: {
              ...
              set: function(v) {
                params2.name = v;
                if (title_row_name) {
                  title_row_name.innerHTML = params2.name;
                }
              }
            },
            /**
        ...
        if (common.isUndefined(params2.parent)) {
          ...
          if (SUPPORTS_LOCAL_STORAGE) {
            if (use_local_storage) {
              ...
              if (saved_gui) {
                params2.load = JSON.parse(saved_gui);
              }
            }
          }
          ...
          var title_row_name = document.createTextNode(params2.name);
        ...
        if (params2.autoPlace) {
          ...
          if (!this.parent) setWidth(_this, params2.width);
        }
      ...
      common.extend(
        ...
        /** @lends dat.gui.GUI */
        {
          ...
          addFolder: function(name) {
            ...
            var new_gui_params = { name, parent: this };
      ...
      function add(gui, object, property, params2) {
      ...
      function addRow(gui, dom2, liBefore) {
        var li = document.createElement("li");
        if (dom2) li.appendChild(dom2);
        if (liBefore) {
      ...
      function augmentController(gui, li, controller) {
        ...
        if (controller instanceof NumberControllerSlider) {
          var box = new NumberControllerBox(
            controller.object,
            controller.property,
          ...
          controller.updateDisplay = common.compose(function(r2) {
            li.style.borderLeftColor = controller.__color.toString();
            return r2;
          }, controller.updateDisplay);
          controller.updateDisplay();
        }
        controller.setValue = common.compose(function(r2) {
      ...
      function recallSavedValue(gui, controller) {
        ...
        if (matched_index != -1) {
          ...
          if (root.load && root.load.remembered) {
            ...
            preset[matched_index][controller.property] !== void 0) {
      ...
      function addSaveMenu(gui) {
        ...
        if (SUPPORTS_LOCAL_STORAGE) {
          let showHideExplain2 = function() {
            explain.style.display = gui.useLocalStorage ? "block" : "none";
          };
          var showHideExplain = showHideExplain2;
  ...
  <div id="dg-save-locally">
    ...
    <div id="dg-local-explain">The values saved to <code>localStorage</code> will
      ...
      dat.controllers.factory = /* @__PURE__ */ (function(OptionController, NumberControllerBox, NumberControllerSlider, StringController, FunctionController, BooleanController, common) {
      ...
      dat.controllers.ColorController = (function(Controller, dom, Color, interpret, common) {
        var ColorController = function(object, property) {
          ...
          dom.bind(this.__selector, "mousedown", function(e) {
            dom.addClass(this, "drag").bind(window, "mouseup", function(e2) {
        ...
        dat.color.Color = (function(interpret, math, toString, common) {
          ...
          dat.color.interpret,
          dat.color.math = /* @__PURE__ */ (function() {
            var tmpComponent;
            return {
...
var require_dat_color = __commonJS({
  "node_modules/dat-gui/vendor/dat.color.js"(exports, module) {
    var dat = module.exports = dat || {};
    dat.color = dat.color || {};
    dat.utils = dat.utils || {};
    dat.utils.common = (function() {
...
var require_dat_gui2 = __commonJS({
  "node_modules/dat-gui/index.js"(exports, module) {
    module.exports = require_dat_gui();
    module.exports.color = require_dat_color();
  }
});
export default require_dat_gui2();
